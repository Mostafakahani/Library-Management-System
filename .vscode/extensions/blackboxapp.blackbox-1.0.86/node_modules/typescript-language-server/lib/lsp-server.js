...
class LspServer {
    ...
    findTsserverPath() {
        ...
        const executable = modules_resolver_1.findPathToModule(this.rootPath(), `.bin/${utils_1.getTsserverExecutable()}`);
        if (executable) {
            return executable;
        }
    ...
    initialize(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { logVerbosity, plugins, preferences } = Object.assign({ logVerbosity: this.options.tsserverLogVerbosity, plugins: [], preferences: {} }, this.initializeParams.initializationOptions);
            ...
            this.tspClient.request("configure" /* Configure */, {
                preferences: Object.assign({ allowTextChangesInNewFiles: true }, preferences)
            });
